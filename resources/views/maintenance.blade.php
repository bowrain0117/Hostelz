...
<head>
	...
	<title>Hostelz.com - Running a quick update</title>
...
<link href="https://fonts.googleapis.com/css?family=Alatsi&display=swap" rel="stylesheet">
	...
	<!-- Google Fonts -->
	<link class="gf-headline" href='https://fonts.googleapis.com/css?family=Alatsi:400&subset=' rel='stylesheet' type='text/css'>
...
#supersized li.prevslide img, #supersized li.activeslide img{ display:inline; }
	...
	html{
		height:100%;
		background: #ffffff url(https://www.hostelz.com/images/best-hostel-price-comparison.jpg); no-repeat center bottom fixed;
...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<h1 id="cspio-headline"><svg width="104" height="24"><use xlink:href="#hostelz-logo"></use></svg></h1>			    				
			
			<div id="cspio-description">We are running a quick update so you can compare hostel prices even better</div>
      
      <div>In the meantime, you can check directly <a href="https://www.hostelz.com/hw" title="Hostelworld " target="_blank" rel="nofollow">Hostelworld.com</a> here</div>
