        ...
        <div data-listing-id="{!! $listing->id !!}" class="col-lg-3 mb-5 hover-animate listing listingLink listing-gridFormat">
    		...
    		<div class="card-body d-flex">
                <div class="w-100">
        			...
        			@if (@$listingTexts[$listing->id])
        			    <div>
        			        {!! nl2br($listingTexts[$listing->id]) !!}
        			    </div>
        			@endif
            	</div>
            	</div>
...
<section class="container py-3" id="privaterooms">
	...
	<p><em>test content</em> Hostels with Private Rooms in {{ $cityInfo->city }} cost on average $127.</p>
	<div class="listingsList pt-3">
		<div class="row">
