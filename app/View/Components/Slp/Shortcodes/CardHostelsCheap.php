...
class CardHostelsCheap extends Component
{
    ...
    {
        return view('slp.components.shortcodes.card-hostels-cheap');
    }
            ...
            function () {
                return $this->hostels->map(function (Listing $listing) {
                    return [
                        ...
                        'breakfast' => $listing->isBreakfastFree(),
                        ...
                        'price' => [
                            'dorm' => $listing->minPriceFormated,
                            'private' => $listing->minPricePrivateFormated,
                        ],
                    ];
                });
            }
